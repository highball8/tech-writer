...
2. Select **Install Security Onion \<version\>** when the Security Onion prompt screen loads.
   ![](/assets/images/security-onion-images-macos-2022/06-onion-config-macos-2022/06-onion-config-macos-2022-002.png)
3. Press `Enter` at the prompt to begin installation.
   ![](/assets/images/security-onion-images-macos-2022/06-onion-config-macos-2022/06-onion-config-macos-2022-003.png)
4. There is a drive-erasure warning. Type `yes` and press `Enter`.
   ![](/assets/images/security-onion-images-macos-2022/06-onion-config-macos-2022/06-onion-config-macos-2022-004.png)
5. Enter an administrative username for the CentOS 7 operating system that will run Security Onion.
   ![](/assets/images/security-onion-images-macos-2022/06-onion-config-macos-2022/06-onion-config-macos-2022-005.png)
6. Set an administrative password and press `Enter`.
   ![](/assets/images/security-onion-images-macos-2022/06-onion-config-macos-2022/06-onion-config-macos-2022-006.png)
7. Re-enter the administrative password and press `Enter`.
   ![](/assets/images/security-onion-images-macos-2022/06-onion-config-macos-2022/06-onion-config-macos-2022-007.png)
8. The output represents the installation of the base CentOS 7 operating system. It will take about 10 minutes. When you see the `Initial Install Complete` prompt, press `Enter`.
   ![](/assets/images/security-onion-images-macos-2022/06-onion-config-macos-2022/06-onion-config-macos-2022-008.png)
9. When the VM comes online, log in with the new credentials you created for the VM.
   ![](/assets/images/security-onion-images-macos-2022/06-onion-config-macos-2022/06-onion-config-macos-2022-009.png)
...
31. Enter an email address. The email address only acts as the username for the account that you will use to log in to the Security Onion dashboard. It will not send emails to this address. So you can use **email@email.com**.
   ![](/assets/images/security-onion-images-macos-2022/06-onion-config-macos-2022/06-onion-config-macos-2022-031.png)
...
45. Because I am using my home network as the "management network," I enter **192.168.1.0/24** in CIDR notation so that devices on that network can navigate to the Security Onion web management interface.
   ![](/assets/images/security-onion-images-macos-2022/06-onion-config-macos-2022/06-onion-config-macos-2022-045.png)
46. The final pane summarizes all of the options you have configured and gives you the choice to accept these configurations and proceed.
   ![](/assets/images/security-onion-images-macos-2022/06-onion-config-macos-2022/06-onion-config-macos-2022-046.png)
