...
2. Enter the folder name (**localLab**) and press `Enter`.
   ![](/assets/images/security-onion-images-macos-2022/03-opn-sense-vm-creation-macos-2022/03-opn-sense-vm-creation-macos-2022-002.png)
3. Click the plus icon and select **New...**.
   ![](/assets/images/security-onion-images-macos-2022/03-opn-sense-vm-creation-macos-2022/03-opn-sense-vm-creation-macos-2022-003.png)
4. Select **Create a custom virtual machine**, then click **Continue**.
   ![](/assets/images/security-onion-images-macos-2022/03-opn-sense-vm-creation-macos-2022/03-opn-sense-vm-creation-macos-2022-004.png)
5. In the **Choose Operating System** dialog, select **Other**, then select **FreeBSD 12 64-bit** and click **Continue**.
   ![](/assets/images/security-onion-images-macos-2022/03-opn-sense-vm-creation-macos-2022/03-opn-sense-vm-creation-macos-2022-005.png)
6. In the **Choose Firmware Type** dialog you can leave the default of **Legacy BIOS**, but OPNsense's amd64 architecture supports UEFI, so I am selecting that. Click **Continue**.
   ![](/assets/images/security-onion-images-macos-2022/03-opn-sense-vm-creation-macos-2022/03-opn-sense-vm-creation-macos-2022-006.png)
7. In the **Choose a Virtual Disk** dialog, leave the radio button set to **Create a new virtual disk** and click **Continue**.
   ![](/assets/images/security-onion-images-macos-2022/03-opn-sense-vm-creation-macos-2022/03-opn-sense-vm-creation-macos-2022-007.png)
...
12. Select **CD/DVD**. This means that when the VM starts, it will use the installation media in the virtual CD/DVD drive. Click **Show All**.
   ![](/assets/images/security-onion-images-macos-2022/03-opn-sense-vm-creation-macos-2022/03-opn-sense-vm-creation-macos-2022-012.png)
13. Click **CD/DVD (IDE)**.
   ![](/assets/images/security-onion-images-macos-2022/03-opn-sense-vm-creation-macos-2022/03-opn-sense-vm-creation-macos-2022-013.png)
14. Click the drop-down menu and select **Choose a disc or disc image**.
   ![](/assets/images/security-onion-images-macos-2022/03-opn-sense-vm-creation-macos-2022/03-opn-sense-vm-creation-macos-2022-014.png)
15. Navigate to your unzipped OPNsense ISO file in the **isos** directory, select it so that the VM will boot from it, and click **Open**.
   ![](/assets/images/security-onion-images-macos-2022/03-opn-sense-vm-creation-macos-2022/03-opn-sense-vm-creation-macos-2022-015.png)
16. Make sure **Connect CD/DVD Drive** is selected and click **Show All**.
   ![](/assets/images/security-onion-images-macos-2022/03-opn-sense-vm-creation-macos-2022/03-opn-sense-vm-creation-macos-2022-016.png)
17. Click **Network Adapter**.
   ![](/assets/images/security-onion-images-macos-2022/03-opn-sense-vm-creation-macos-2022/03-opn-sense-vm-creation-macos-2022-017.png)
...
23. A dialog for **Network Adapter 3** displays. Under **Custom**, select **HOME_NET_LAN**, click **Add Device...**, then click **Show All**.
   ![](/assets/images/security-onion-images-macos-2022/03-opn-sense-vm-creation-macos-2022/03-opn-sense-vm-creation-macos-2022-022.png)

    * **Note:** **HOME_NET_LAN** is the network where you will deploy Security Onion.

24. Click **Processors & Memory**.
   ![](/assets/images/security-onion-images-macos-2022/03-opn-sense-vm-creation-macos-2022/03-opn-sense-vm-creation-macos-2022-023.png)
25. Because this is a small virtual network on the host Mac and we will have only a few VMs and not a lot of traffic, you can use less processing power for the OPNsense router. (You will need it for the other VMs.) Click **Processors** and select **2 processor cores**.
   ![](/assets/images/security-onion-images-macos-2022/03-opn-sense-vm-creation-macos-2022/03-opn-sense-vm-creation-macos-2022-024.png)
26. Change the **Memory** to **1024**.
   ![](/assets/images/security-onion-images-macos-2022/03-opn-sense-vm-creation-macos-2022/03-opn-sense-vm-creation-macos-2022-025.png)
27. You are done configuring your OPNsense VM. You can close the **Settings** window. In the window for the VM itself (the window will be labeled with what you named the VM when you saved it), click the icon next to the playhead in the top-left corner of the window. (If you hover over the icon, it will display the text **Manage this virtual machine's snapshots**.
   ![](/assets/images/security-onion-images-macos-2022/03-opn-sense-vm-creation-macos-2022/03-opn-sense-vm-creation-macos-2022-026.png)
...
29. Give your snapshot a name and description (for example, **v0_pre_boot**) and click **Take**. A snapshot allows you to roll back to the VM's state at the time of the snapshot. If anything goes wrong, you can roll back to this snapshot and start over but still skip the above steps.
   ![](/assets/images/security-onion-images-macos-2022/03-opn-sense-vm-creation-macos-2022/03-opn-sense-vm-creation-macos-2022-028.png)
30. When you are done you can close the **Snapshots** window.
   ![](/assets/images/security-onion-images-macos-2022/03-opn-sense-vm-creation-macos-2022/03-opn-sense-vm-creation-macos-2022-029.png)
31. In your Virtual Machine library, select your OPNsense VM and drag it into the **localLab** folder.
   ![](/assets/images/security-onion-images-macos-2022/03-opn-sense-vm-creation-macos-2022/03-opn-sense-vm-creation-macos-2022-030.png)
